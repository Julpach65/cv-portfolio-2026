...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu Overlay - Movido fuera de <nav> para evitar clipping de altura */}
                ...
                {isMenuOpen && (
                    <div className="md:hidden">
                        ...
                        <motion.div
                            ...
                            className="fixed inset-0 bg-black/95 backdrop-blur-sm z-[90]"
                        />
                        ...
                        <motion.div
                            ...
                            className="fixed top-0 left-0 w-[280px] h-screen bg-[#111114] border-r border-white/10 z-[100] p-8 flex flex-col shadow-[10px_0_30px_rgba(0,0,0,0.6)]"
                        >
